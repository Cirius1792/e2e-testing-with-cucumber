...
public class GlobalErrorAttributes extends DefaultErrorAttributes {
  static final String INTERNAL_SERVER_ERROR_MESSAGE = "An error occurred while serving the request";
  ...
  public Map<String, Object> getErrorAttributes(
    ...
    if (exceptionRuleOptional.isEmpty()) log.error("Intercepted Unknown Error", error);
    return exceptionRuleOptional
        ...
        .orElseGet(
            () ->
                Map.of(
                    ErrorAttributesKey.STATUS_CODE.getKey(),
                    HttpStatus.INTERNAL_SERVER_ERROR.value(),
                    ErrorAttributesKey.DESCRIPTION.getKey(),
